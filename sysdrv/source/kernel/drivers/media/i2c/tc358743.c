...
static const u8 tc358743_default_edid_1080p30[] = {
...
static int tc358743_load_default_edid(struct v4l2_subdev *sd);
...
static int tc358743_load_default_edid(struct v4l2_subdev *sd)
{
	struct v4l2_subdev_edid edid = {
		.pad = 0,
		.start_block = 0,
		.blocks = ARRAY_SIZE(tc358743_default_edid_1080p30) /
			  EDID_BLOCK_SIZE,
		.edid = (u8 *)tc358743_default_edid_1080p30,
	};

	return tc358743_s_edid(sd, &edid);
}
...
static int tc358743_probe(struct i2c_client *client)
{
	...
	err = tc358743_load_default_edid(sd);
	if (err)
		goto err_work_queues;
